...
download_cpolar() {
  DOWNLOAD_LINK="https://www.cpolar.com/static/downloads/releases/$RELEASE_VERSION/cpolar-stable-linux-$MACHINE.zip"
...
decompression() {
  ...
  DOWNLOAD_CONFIG_LINK="https://www.cpolar.com/static/downloads/cpolar.demo.yml" 
  ...
  DOWNLOAD_SERVICE_CONFIG_LINK="https://www.cpolar.com/static/downloads/cpolar.service"
  ...
  DOWNLOAD_SERVICE_AT_CONFIG_LINK="https://www.cpolar.com/static/downloads/cpolar@.service"
